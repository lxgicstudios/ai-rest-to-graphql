...
![npm](https://img.shields.io/npm/v/ai-rest-to-graphql)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-rest-to-graphql)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# REST to GraphQL conversion and optimization tools

REST to GraphQL converter. Transforms REST APIs into GraphQL schemas with resolvers.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-rest-to-graphql.svg)](https://badge.fury.io/js/ai-rest-to-graphql)
